...
/**
     ...
     * @return void
     */
    public function refundOrder($order_id, $klarna_idempotency_key = null, $body = null, string $contentType = self::contentTypes['refundOrder'][0])
    {
        $this->refundOrderWithHttpInfo($order_id, $klarna_idempotency_key, $body, $contentType);
    }
     ...
     */
    public function refundOrderWithHttpInfo($order_id, $klarna_idempotency_key = null, $body = null, string $contentType = self::contentTypes['refundOrder'][0])
    {
        $request = $this->refundOrderRequest($order_id, $klarna_idempotency_key, $body, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refundOrderAsync($order_id, $klarna_idempotency_key = null, $body = null, string $contentType = self::contentTypes['refundOrder'][0])
    {
        return $this->refundOrderAsyncWithHttpInfo($order_id, $klarna_idempotency_key, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refundOrderAsyncWithHttpInfo($order_id, $klarna_idempotency_key = null, $body = null, string $contentType = self::contentTypes['refundOrder'][0])
    {
        $returnType = '';
        $request = $this->refundOrderRequest($order_id, $klarna_idempotency_key, $body, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function refundOrderRequest($order_id, $klarna_idempotency_key = null, $body = null, string $contentType = self::contentTypes['refundOrder'][0])
    {
