...
class OrdersApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateAuthorizationRequest($order_id, $klarna_idempotency_key = null, $body = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateConsumerDetailsRequest($order_id, $klarna_idempotency_key = null, $body = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateMerchantReferencesRequest($order_id, $klarna_idempotency_key = null, $body = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
