...
/**
     ...
     * @return void
     */
    public function appendShippingInfo($capture_id, $order_id, $klarna_idempotency_key = null, $body = null, string $contentType = self::contentTypes['appendShippingInfo'][0])
    {
        $this->appendShippingInfoWithHttpInfo($capture_id, $order_id, $klarna_idempotency_key, $body, $contentType);
    }
     ...
     */
    public function appendShippingInfoWithHttpInfo($capture_id, $order_id, $klarna_idempotency_key = null, $body = null, string $contentType = self::contentTypes['appendShippingInfo'][0])
    {
        $request = $this->appendShippingInfoRequest($capture_id, $order_id, $klarna_idempotency_key, $body, $contentType);
     ...
     */
    public function appendShippingInfoAsync($capture_id, $order_id, $klarna_idempotency_key = null, $body = null, string $contentType = self::contentTypes['appendShippingInfo'][0])
    {
        return $this->appendShippingInfoAsyncWithHttpInfo($capture_id, $order_id, $klarna_idempotency_key, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function appendShippingInfoAsyncWithHttpInfo($capture_id, $order_id, $klarna_idempotency_key = null, $body = null, string $contentType = self::contentTypes['appendShippingInfo'][0])
    {
        $returnType = '';
        $request = $this->appendShippingInfoRequest($capture_id, $order_id, $klarna_idempotency_key, $body, $contentType);
     ...
     */
    public function appendShippingInfoRequest($capture_id, $order_id, $klarna_idempotency_key = null, $body = null, string $contentType = self::contentTypes['appendShippingInfo'][0])
    {
     ...
     * @return void
     */
    public function captureOrder($order_id, $body, $klarna_idempotency_key = null, string $contentType = self::contentTypes['captureOrder'][0])
    {
        $this->captureOrderWithHttpInfo($order_id, $body, $klarna_idempotency_key, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function captureOrderWithHttpInfo($order_id, $body, $klarna_idempotency_key = null, string $contentType = self::contentTypes['captureOrder'][0])
    {
        $request = $this->captureOrderRequest($order_id, $body, $klarna_idempotency_key, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function captureOrderAsync($order_id, $body, $klarna_idempotency_key = null, string $contentType = self::contentTypes['captureOrder'][0])
    {
        return $this->captureOrderAsyncWithHttpInfo($order_id, $body, $klarna_idempotency_key, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function captureOrderAsyncWithHttpInfo($order_id, $body, $klarna_idempotency_key = null, string $contentType = self::contentTypes['captureOrder'][0])
    {
        $returnType = '';
        $request = $this->captureOrderRequest($order_id, $body, $klarna_idempotency_key, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function captureOrderRequest($order_id, $body, $klarna_idempotency_key = null, string $contentType = self::contentTypes['captureOrder'][0])
    {
     ...
     * @return void
     */
    public function extendDueDate($capture_id, $order_id, $klarna_idempotency_key = null, $body = null, string $contentType = self::contentTypes['extendDueDate'][0])
    {
        $this->extendDueDateWithHttpInfo($capture_id, $order_id, $klarna_idempotency_key, $body, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function extendDueDateWithHttpInfo($capture_id, $order_id, $klarna_idempotency_key = null, $body = null, string $contentType = self::contentTypes['extendDueDate'][0])
    {
        $request = $this->extendDueDateRequest($capture_id, $order_id, $klarna_idempotency_key, $body, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function extendDueDateAsync($capture_id, $order_id, $klarna_idempotency_key = null, $body = null, string $contentType = self::contentTypes['extendDueDate'][0])
    {
        return $this->extendDueDateAsyncWithHttpInfo($capture_id, $order_id, $klarna_idempotency_key, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function extendDueDateAsyncWithHttpInfo($capture_id, $order_id, $klarna_idempotency_key = null, $body = null, string $contentType = self::contentTypes['extendDueDate'][0])
    {
        $returnType = '';
        $request = $this->extendDueDateRequest($capture_id, $order_id, $klarna_idempotency_key, $body, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function extendDueDateRequest($capture_id, $order_id, $klarna_idempotency_key = null, $body = null, string $contentType = self::contentTypes['extendDueDate'][0])
    {
