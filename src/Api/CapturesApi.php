...
class CapturesApi
{
     ...
     * @return void
     */
    public function appendShippingInfo($order_id, $capture_id, $update_shipping_info, $klarna_idempotency_key = null, string $contentType = self::contentTypes['appendShippingInfo'][0])
    {
        $this->appendShippingInfoWithHttpInfo($order_id, $capture_id, $update_shipping_info, $klarna_idempotency_key, $contentType);
    }
     ...
     */
    public function appendShippingInfoWithHttpInfo($order_id, $capture_id, $update_shipping_info, $klarna_idempotency_key = null, string $contentType = self::contentTypes['appendShippingInfo'][0])
    {
        $request = $this->appendShippingInfoRequest($order_id, $capture_id, $update_shipping_info, $klarna_idempotency_key, $contentType);
     ...
     */
    public function appendShippingInfoAsync($order_id, $capture_id, $update_shipping_info, $klarna_idempotency_key = null, string $contentType = self::contentTypes['appendShippingInfo'][0])
    {
        return $this->appendShippingInfoAsyncWithHttpInfo($order_id, $capture_id, $update_shipping_info, $klarna_idempotency_key, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function appendShippingInfoAsyncWithHttpInfo($order_id, $capture_id, $update_shipping_info, $klarna_idempotency_key = null, string $contentType = self::contentTypes['appendShippingInfo'][0])
    {
        $returnType = '';
        $request = $this->appendShippingInfoRequest($order_id, $capture_id, $update_shipping_info, $klarna_idempotency_key, $contentType);
     ...
     */
    public function appendShippingInfoRequest($order_id, $capture_id, $update_shipping_info, $klarna_idempotency_key = null, string $contentType = self::contentTypes['appendShippingInfo'][0])
    {
        ...
        if ($update_shipping_info === null || (is_array($update_shipping_info) && count($update_shipping_info) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_shipping_info when calling appendShippingInfo'
            );
        }
     ...
     *
     * @param  string $order_id Order id (required)
     * @param  \Klarna\OrderManagement\Model\CaptureObject $capture_object capture_object (required)
     * @param  string|null $klarna_idempotency_key This header will guarantee the idempotency of the operation. The key should be unique and is recommended to be a UUID version 4. Retries of requests are safe to be applied in case of errors such as network errors, socket errors and timeouts. Input values of the operation are disregarded when evaluating the idempotency of the operation, only the key matters. (optional)
     ...
     *
     * @param  string $order_id Order id (required)
     * @param  \Klarna\OrderManagement\Model\CaptureObject $capture_object (required)
     * @param  string|null $klarna_idempotency_key This header will guarantee the idempotency of the operation. The key should be unique and is recommended to be a UUID version 4. Retries of requests are safe to be applied in case of errors such as network errors, socket errors and timeouts. Input values of the operation are disregarded when evaluating the idempotency of the operation, only the key matters. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['captureOrder'] to see the possible values for this operation
     *
     * @throws \Klarna\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @param  string $order_id Order id (required)
     * @param  string $capture_id Capture id (required)
     * @param  \Klarna\OrderManagement\Model\ExtendDueDateRequest $extend_due_date_request extend_due_date_request (required)
     * @param  string|null $klarna_idempotency_key This header will guarantee the idempotency of the operation. The key should be unique and is recommended to be a UUID version 4. Retries of requests are safe to be applied in case of errors such as network errors, socket errors and timeouts. Input values of the operation are disregarded when evaluating the idempotency of the operation, only the key matters. (optional)
     ...
     * @return void
     */
    public function extendDueDate($order_id, $capture_id, $extend_due_date_request, $klarna_idempotency_key = null, string $contentType = self::contentTypes['extendDueDate'][0])
    {
        $this->extendDueDateWithHttpInfo($order_id, $capture_id, $extend_due_date_request, $klarna_idempotency_key, $contentType);
    }
     ...
     * @param  string $order_id Order id (required)
     * @param  string $capture_id Capture id (required)
     * @param  \Klarna\OrderManagement\Model\ExtendDueDateRequest $extend_due_date_request (required)
     * @param  string|null $klarna_idempotency_key This header will guarantee the idempotency of the operation. The key should be unique and is recommended to be a UUID version 4. Retries of requests are safe to be applied in case of errors such as network errors, socket errors and timeouts. Input values of the operation are disregarded when evaluating the idempotency of the operation, only the key matters. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['extendDueDate'] to see the possible values for this operation
     *
     * @throws \Klarna\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function extendDueDateWithHttpInfo($order_id, $capture_id, $extend_due_date_request, $klarna_idempotency_key = null, string $contentType = self::contentTypes['extendDueDate'][0])
    {
        $request = $this->extendDueDateRequest($order_id, $capture_id, $extend_due_date_request, $klarna_idempotency_key, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function extendDueDateAsync($order_id, $capture_id, $extend_due_date_request, $klarna_idempotency_key = null, string $contentType = self::contentTypes['extendDueDate'][0])
    {
        return $this->extendDueDateAsyncWithHttpInfo($order_id, $capture_id, $extend_due_date_request, $klarna_idempotency_key, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function extendDueDateAsyncWithHttpInfo($order_id, $capture_id, $extend_due_date_request, $klarna_idempotency_key = null, string $contentType = self::contentTypes['extendDueDate'][0])
    {
        $returnType = '';
        $request = $this->extendDueDateRequest($order_id, $capture_id, $extend_due_date_request, $klarna_idempotency_key, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function extendDueDateRequest($order_id, $capture_id, $extend_due_date_request, $klarna_idempotency_key = null, string $contentType = self::contentTypes['extendDueDate'][0])
    {
        ...
        // verify the required parameter 'extend_due_date_request' is set
        if ($extend_due_date_request === null || (is_array($extend_due_date_request) && count($extend_due_date_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $extend_due_date_request when calling extendDueDate'
            );
        }
     ...
     */
    public function getCapture($order_id, $capture_id, string $contentType = self::contentTypes['getCapture'][0])
    {
        list($response) = $this->getCaptureWithHttpInfo($order_id, $capture_id, $contentType);
        return $response;
    }
     ...
     */
    public function getCaptureWithHttpInfo($order_id, $capture_id, string $contentType = self::contentTypes['getCapture'][0])
    {
        $request = $this->getCaptureRequest($order_id, $capture_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCaptureAsync($order_id, $capture_id, string $contentType = self::contentTypes['getCapture'][0])
    {
        return $this->getCaptureAsyncWithHttpInfo($order_id, $capture_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCaptureAsyncWithHttpInfo($order_id, $capture_id, string $contentType = self::contentTypes['getCapture'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCaptureRequest($order_id, $capture_id, string $contentType = self::contentTypes['getCapture'][0])
    {
     ...
     */
    public function getOptionsForExtendDueDate($order_id, $capture_id, string $contentType = self::contentTypes['getOptionsForExtendDueDate'][0])
    {
        list($response) = $this->getOptionsForExtendDueDateWithHttpInfo($order_id, $capture_id, $contentType);
        return $response;
    }
     ...
     */
    public function getOptionsForExtendDueDateWithHttpInfo($order_id, $capture_id, string $contentType = self::contentTypes['getOptionsForExtendDueDate'][0])
    {
        $request = $this->getOptionsForExtendDueDateRequest($order_id, $capture_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOptionsForExtendDueDateAsync($order_id, $capture_id, string $contentType = self::contentTypes['getOptionsForExtendDueDate'][0])
    {
        return $this->getOptionsForExtendDueDateAsyncWithHttpInfo($order_id, $capture_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOptionsForExtendDueDateAsyncWithHttpInfo($order_id, $capture_id, string $contentType = self::contentTypes['getOptionsForExtendDueDate'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOptionsForExtendDueDateRequest($order_id, $capture_id, string $contentType = self::contentTypes['getOptionsForExtendDueDate'][0])
    {
     ...
     * @return void
     */
    public function triggerSendOut($order_id, $capture_id, $klarna_idempotency_key = null, string $contentType = self::contentTypes['triggerSendOut'][0])
    {
        $this->triggerSendOutWithHttpInfo($order_id, $capture_id, $klarna_idempotency_key, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function triggerSendOutWithHttpInfo($order_id, $capture_id, $klarna_idempotency_key = null, string $contentType = self::contentTypes['triggerSendOut'][0])
    {
        $request = $this->triggerSendOutRequest($order_id, $capture_id, $klarna_idempotency_key, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function triggerSendOutAsync($order_id, $capture_id, $klarna_idempotency_key = null, string $contentType = self::contentTypes['triggerSendOut'][0])
    {
        return $this->triggerSendOutAsyncWithHttpInfo($order_id, $capture_id, $klarna_idempotency_key, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function triggerSendOutAsyncWithHttpInfo($order_id, $capture_id, $klarna_idempotency_key = null, string $contentType = self::contentTypes['triggerSendOut'][0])
    {
        $returnType = '';
        $request = $this->triggerSendOutRequest($order_id, $capture_id, $klarna_idempotency_key, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function triggerSendOutRequest($order_id, $capture_id, $klarna_idempotency_key = null, string $contentType = self::contentTypes['triggerSendOut'][0])
    {
