...
class OrderLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['total_amount'] > 200000000)) {
            $invalidProperties[] = "invalid value for 'total_amount', must be smaller than or equal to 200000000.";
        }

        if (!is_null($this->container['total_discount_amount']) && ($this->container['total_discount_amount'] > 200000000)) {
            $invalidProperties[] = "invalid value for 'total_discount_amount', must be smaller than or equal to 200000000.";
        }
        ...
        if (!is_null($this->container['total_tax_amount']) && ($this->container['total_tax_amount'] > 200000000)) {
            $invalidProperties[] = "invalid value for 'total_tax_amount', must be smaller than or equal to 200000000.";
        }
        ...
        if (($this->container['unit_price'] > 200000000)) {
            $invalidProperties[] = "invalid value for 'unit_price', must be smaller than or equal to 200000000.";
        }
     ...
     * Sets image_url
     *
     * @param string|null $image_url URL to an image that can be embedded in communications between Klarna and the customer.
     *
     * @return self
     */
     ...
     * Sets merchant_data
     *
     * @param string|null $merchant_data Data about the order line.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Descriptive item name.
     *
     * @return self
     */
     ...
     * Sets product_url
     *
     * @param string|null $product_url URL to the product that can be used in communications between Klarna and the customer.
     *
     * @return self
     */
     ...
     * Sets quantity_unit
     *
     * @param string|null $quantity_unit Unit used to describe the quantity.
     *
     * @return self
     */
     ...
     * Sets tax_rate
     *
     * @param int|null $tax_rate The tax rate in percent with two implicit decimals.
     *
     * @return self
     */
    ...
    public function setTotalAmount($total_amount)
    {
        ...
        if (($total_amount > 200000000)) {
            throw new \InvalidArgumentException('invalid value for $total_amount when calling OrderLine., must be smaller than or equal to 200000000.');
        }
     ...
     *
     * @param int|null $total_discount_amount The discount amount in minor units. Includes tax. Example: 1200 = $12. Max value: 200000000
     *
     * @return self
     */
    public function setTotalDiscountAmount($total_discount_amount)
    {
        ...
        if (($total_discount_amount > 200000000)) {
            throw new \InvalidArgumentException('invalid value for $total_discount_amount when calling OrderLine., must be smaller than or equal to 200000000.');
        }
     ...
     *
     * @param int|null $total_tax_amount The total tax amount in minor units.
     *
     * @return self
     */
    public function setTotalTaxAmount($total_tax_amount)
    {
        ...
        if (($total_tax_amount > 200000000)) {
            throw new \InvalidArgumentException('invalid value for $total_tax_amount when calling OrderLine., must be smaller than or equal to 200000000.');
        }
     ...
     * Sets type
     *
     * @param string|null $type Order line type.
     *
     * @return self
     */
    ...
    public function setUnitPrice($unit_price)
    {
        ...
        if (($unit_price > 200000000)) {
            throw new \InvalidArgumentException('invalid value for $unit_price when calling OrderLine., must be smaller than or equal to 200000000.');
        }
