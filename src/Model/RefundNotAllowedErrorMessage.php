...
/**
 * RefundNotAllowedErrorMessage Class Doc Comment
 *
 * @category Class
 * @package  Klarna\OrderManagement
 * @author   OpenAPI Generator team
 ...
 */
class RefundNotAllowedErrorMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Refund not allowed error message';
