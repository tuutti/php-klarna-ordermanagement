...
class UpdateAuthorization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateAuthorization';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['order_amount'] > 200000000)) {
            $invalidProperties[] = "invalid value for 'order_amount', must be smaller than or equal to 200000000.";
        }
    ...
    public function setOrderAmount($order_amount)
    {
        ...
        if (($order_amount > 200000000)) {
            throw new \InvalidArgumentException('invalid value for $order_amount when calling UpdateAuthorization., must be smaller than or equal to 200000000.');
        }
        if (($order_amount < 0)) {
