 ...
 */
class OptionDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OptionDto';
     ...
     * Sets amount
     *
     * @param int|null $amount The fee for extending the due date this many days. In minor units.
     *
     * @return self
     */
