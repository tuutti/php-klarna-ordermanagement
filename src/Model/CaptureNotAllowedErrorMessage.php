...
/**
 * CaptureNotAllowedErrorMessage Class Doc Comment
 *
 * @category Class
 * @package  Klarna\OrderManagement
 * @author   OpenAPI Generator team
 ...
 */
class CaptureNotAllowedErrorMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Capture not allowed error message';
