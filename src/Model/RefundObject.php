...
class RefundObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['refunded_amount'] > 200000000)) {
            $invalidProperties[] = "invalid value for 'refunded_amount', must be smaller than or equal to 200000000.";
        }
    ...
    public function setRefundedAmount($refunded_amount)
    {
        ...
        if (($refunded_amount > 200000000)) {
            throw new \InvalidArgumentException('invalid value for $refunded_amount when calling RefundObject., must be smaller than or equal to 200000000.');
        }
