...
class CaptureObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['captured_amount'] > 200000000)) {
            $invalidProperties[] = "invalid value for 'captured_amount', must be smaller than or equal to 200000000.";
        }
    ...
    public function setCapturedAmount($captured_amount)
    {
        ...
        if (($captured_amount > 200000000)) {
            throw new \InvalidArgumentException('invalid value for $captured_amount when calling CaptureObject., must be smaller than or equal to 200000000.');
        }
