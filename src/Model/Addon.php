...
class Addon implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('user_input', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['price'] === null && !$this->isNullableSetToNull('price')) {
     ...
     * Sets price
     *
     * @param int|null $price The price of the add-on
     *
     * @return self
     */
    public function setPrice($price)
    {
        ...
        $allowedValues = $this->getPriceAllowableValues();
        if (!is_null($price) && !in_array($price, $allowedValues, true)) {
    ...
    public function setUserInput($user_input)
    {
        if (is_null($user_input)) {
            throw new \InvalidArgumentException('non-nullable user_input cannot be null');
        }
